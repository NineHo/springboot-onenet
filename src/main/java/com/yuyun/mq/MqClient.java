...
public class MqClient {
    ...
    public synchronized boolean connect(){
        ...
        String userName = "mq_data"; //MQID

        String mqTopic = "mq_topic"; //mq topic
        String mqSub = "mq_topic_data"; // mq sub
    ...
    private void resetOptions(){
        String userName = "mq_data"; //MQID
        String accessKey = "nusgL6obtieyXq6JKCpb6Rk8wdZHi9f+bY+F8w5aWeE="; //mq access_key
